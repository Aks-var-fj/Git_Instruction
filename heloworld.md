...
Для того чтобы исключить из отслеживаня в репозитории определенный файлы или папки, необходимо там создатьaaaaaaaaaaaaaaaaaaaaaa файл ***.gitignore*** и записать в него их названия или шаблоны, соответствующие таким файлам или папкам.
...
```
Список веток в репозитории мaaaaaaaaaaaaaaожно посмотреть с помощью команды:
```
git branch
```
