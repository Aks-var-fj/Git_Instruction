...
Для того чтобы исключить из отслеживаня в репозитории определенный файлы или папки, необходимо там создать фffffffffffffайл ***.gitignore*** и записать в него их названия или шаблоны, соответствующие таким файлам или папкам.
...
```
Также можно использовать индекс `-b` перед названием файла, что позволяет создать и сразу перейти в новую ветку.
Список веток в репозитории можно посмотреть с помощью команды:
```
git branch
```
Текущая ветка будет отмечена звеffffffffffffздочкой: **\*createBranches**
